...
thumbnail: "/images/projects/project-01/thumbnail.webp"
stack: [
  "Python",
  "Pandas",
  "SciPy",
...
<img src={`${import.meta.env.BASE_URL}/images/projects/project-01/thumbnail.webp`} alt="Rolling Mean Analysis" />
*Hình 1: Biểu đồ trung bình trượt (Rolling Mean 24h) nhận diện xu hướng biến động theo mùa vụ.*

<img src={`${import.meta.env.BASE_URL}/images/projects/project-01/figure-2.webp`} alt="Distribution Comparison" />
