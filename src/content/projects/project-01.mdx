...
<img src={`${import.meta.env.BASE_URL}images/projects/poisson_process_statistical_analytics/Figure_1.png`} alt="Rolling Mean Analysis" />
*Hình 1: Biểu đồ trung bình trượt (Rolling Mean 24h) nhận diện xu hướng biến động theo mùa vụ.*

<img src={`${import.meta.env.BASE_URL}images/projects/poisson_process_statistical_analytics/Figure_2.png`} alt="Distribution Comparison" />
