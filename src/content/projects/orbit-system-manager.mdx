...
thumbnail: "/images/projects/orbit-system-manager/thumbnail.webp"
...
<img src={`${import.meta.env.BASE_URL}/images/projects/orbit-system-manager/architecture.webp`} alt="Architecture Overview" />
