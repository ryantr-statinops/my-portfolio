    ...
    <section id="portfolio-registry" className="relative flex min-h-screen w-full items-center overflow-hidden bg-background py-12">
      <div className="mx-auto w-full max-w-[1600px] px-6 md:px-10">
        ...
        <div className="glass-premium reveal overflow-hidden rounded-2xl border border-border/80 bg-card/20">
          ...
          </div> : <p data-filter-empty className="px-5 py-12 text-center font-mono text-xs uppercase tracking-widest text-muted">No systems match the active filter.</p>}
        </div>
        <div className="reveal mt-8 flex items-center justify-between font-mono text-[9px] uppercase tracking-[0.2em] text-muted"><div className="flex items-center gap-4"><span>[ SCANNING_COMPLETE ]</span><span className="animate-pulse">_</span></div><div className="flex gap-8"><span>Integrity: 100% Verified</span><span>Encryption: AES-256</span></div></div>
      </div>
    </section>
  );
}
